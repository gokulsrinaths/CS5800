...
public class Driver {
    public static void main(String[] args) {
        ...
        Customer customer1 = new Customer("Gokul", "No Restriction");
        Customer customer2 = new Customer("Srinath", "Paleo");
        Customer customer3 = new Customer("Seetha", "Vegan");
        Customer customer4 = new Customer("Ram", "Nut Allergy");
        Customer customer5 = new Customer("Sir", "Vegan");
        Customer customer6 = new Customer("Madame", "Paleo");
